...
export const LABEL = "com.wendell.lixi-review-docs-realtime-sync";
const execFile = promisify(execFileCallback);
const moduleDir = dirname(fileURLToPath(import.meta.url));

export function launchAgentPaths(home = homedir()) {
  const supportDir = join(home, "Library/Application Support/LixiReviewDocsSync");
  const logsDir = join(home, "Library/Logs/LixiReviewDocsSync");
  return {
    supportDir,
...
async function main() {
  ...
  const sourceDir =
    argument("--source") ??
    "/Users/wendell/Project/LIXI/Learn/.local/lixi-review-fixtures/scenario-markdown-samples";
