...
这是 LIXI Review Docs 的独立发布仓库。生产站点由 GitHub Pages 托管：

- 公开地址：<https://1firecracker.github.io/lixi-review-docs/>
- 发布仓库：<https://github.com/1firecracker/lixi-review-docs>
...
- Label：`com.wendell.lixi-review-docs-sync`
- 日志：`~/Library/Logs/LixiReviewDocsSync/`
...
卸载只移除该 LaunchAgent，不删除来源文档或已发布快照。
